...
void Assets::Init()
{
	...
	texture["Bomber"] = new Texture("Assets//bomber.tga", GL_NEAREST, GL_NEAREST_MIPMAP_LINEAR);
	texture["Turret"] = new Texture("Assets//turret.tga", GL_NEAREST, GL_NEAREST_MIPMAP_LINEAR);
