...
void PlayState::Init()
{
...

	{
		...
		child->GetComponent<Button>()->text = child->AttachChild(EntityFactory::CreateTextGUI(Vector2(0, -24), ToString(TowerDatabase::GetData("bubble_blower")[0].cost, 'G').c_str(), 200))
		...
		child->GetComponent<Button>()->text = child->AttachChild(EntityFactory::CreateTextGUI(Vector2(0, -24), ToString(TowerDatabase::GetData("fountain")[0].cost, 'G').c_str(), 200))
			->GetComponent<TextRenderer2D>();
		...
		child->GetComponent<Button>()->text = child->AttachChild(EntityFactory::CreateTextGUI(Vector2(0, -24), ToString(TowerDatabase::GetData("sniper")[0].cost, 'G').c_str(), 200))
			->GetComponent<TextRenderer2D>();
		...
		child->GetComponent<Button>()->text = child->AttachChild(EntityFactory::CreateTextGUI(Vector2(0, -24), ToString(TowerDatabase::GetData("dispenser")[0].cost, 'G').c_str(), 200))
			->GetComponent<TextRenderer2D>();
		editor->GetComponent<TowerGUI>()->AddButton("dispenser", child->GetComponent<Button>());

		TowerDatabase::Init("bubble_cannon");
		...
		child->GetComponent<Button>()->text = child->AttachChild(EntityFactory::CreateTextGUI(Vector2(0, -24), ToString(TowerDatabase::GetData("bubble_cannon")[0].cost, 'G').c_str(), 200))
			->GetComponent<TextRenderer2D>();
		editor->GetComponent<TowerGUI>()->AddButton("bubble_cannon", child->GetComponent<Button>());

		TowerDatabase::Init("glue_gun");
		...
		child->GetComponent<Button>()->text = child->AttachChild(EntityFactory::CreateTextGUI(Vector2(0, -24), ToString(TowerDatabase::GetData("glue_gun")[0].cost, 'G').c_str(), 200))
			->GetComponent<TextRenderer2D>();
		editor->GetComponent<TowerGUI>()->AddButton("glue_gun", child->GetComponent<Button>());
	}

	{
		...
		{
			Entity* child = entity->AttachChild(EntityFactory::CreateTextGUI(Vector2(8, -32), "Damage:", 150, false));
		...
		{
			Entity* child = entity->AttachChild(EntityFactory::CreateTextGUI(Vector2(8, -64), "Range:", 150, false));
		...
		{
			Entity* child = entity->AttachChild(EntityFactory::CreateTextGUI(Vector2(8, -96), "Accuracy:", 150, false));
			child->GetComponent<TextRenderer2D>()->color.Set(1, 0.25f, 0);
		...
		{
			Entity* child = entity->AttachChild(EntityFactory::CreateTextGUI(Vector2(8, -128), "Speed:", 150, false));
		...
		{
			Entity* child = entity->AttachChild(EntityFactory::CreateTextGUI(Vector2(8, -160), "Projectiles:", 150, false));
			child = child->AttachChild(EntityFactory::CreateTextGUI(Vector2(150, 0), "", 150, false));

			editor->GetComponent<TowerGUI>()->projectiles = child->GetComponent<TextRenderer2D>();
		}
		{
			Entity* child = entity->AttachChild(EntityFactory::CreateButton(Vector2(64, -230), Vector2(96, 32), NULL, Vector3(0, 0.6f, 0), true));
			child->GetComponent<Button>()->SetKey(GLFW_KEY_U);
