...
public:
	...
	static Mtx44 GetTransformation(const Vector3& Txyz, float Sxyz);
	static Mtx44 GetTransformation(float Tx = 0, float Ty = 0, float Tz = 0, float Sx = 1, float Sy = 1, float Sz = 1, float Rx = 0, float Ry = 0, float Rz = 0);
	static Mtx44 GetIdentity();

	void SetToTransform(float Tx = 0, float Ty = 0, float Tz = 0, float Sx = 1, float Sy = 1, float Sz = 1, float Rx = 0, float Ry = 0, float Rz = 0);
